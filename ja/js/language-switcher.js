...
(function () {
  ...
  function updateLanguageSwitcher() {
    ...
    // console.log(
    //   "Found language switch link:",
    //   langSwitchLink.href,
    //   langSwitchLink.textContent,
    // );

    // Show loading state
    langSwitchLink.style.opacity = "0.7"; // Using inline style for temporary loading state
  ...
  function getTranslationMetadata() {
    ...
    if (pathMatch) {
      ...
      // console.log("Detected language path:", {
      //   basePath,
      //   currentLang,
      //   pagePath,
      // });
  ...
  // Removed unused function checkTranslationExists

  function updateLanguageLink(linkElement, translations) {
    const currentLang = detectCurrentLanguage();
    const targetLang = currentLang === "en" ? "ja" : "en";

    // console.log("Updating language link:", {
    //   currentLang,
    //   targetLang,
    //   translations,
    // });
  ...
  function disableLanguageSwitch(linkElement) {
    ...
    linkElement.style.opacity = ""; // Let CSS handle styling
    linkElement.style.cursor = "";
