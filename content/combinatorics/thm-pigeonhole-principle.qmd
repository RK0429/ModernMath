...
Let $f: A \to B$ be a function where $A$ and $B$ are finite @def-set s with $|A| > |B|$. Then $f$ is not injective; that is, there exist distinct elements $a_1, a_2 \in A$ such that $f(a_1) = f(a_2)$.
