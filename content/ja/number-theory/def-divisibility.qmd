...
整除性は数論において基本的な概念であり、一つの整数が別の整数を余りなく割ることができるかどうかを記述します。
...
graph TD
    ...
    def-congruence["定義: 合同（モジュラー算術）"]:::definition
    ...
    click thm-chinese-remainder "thm-chinese-remainder.html" "定理: 中国剰余定理へ"
    click thm-fermat-little "thm-fermat-little.html" "定理: フェルマーの小定理へ"
    click def-congruence "def-congruence.html" "定義: 合同（モジュラー算術）へ"
```
