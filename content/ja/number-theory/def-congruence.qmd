...
$n$ を法とする合同は、整数の[集合](../logic-set-theory/def-set.qmd)上の[同値関係](../logic-set-theory/def-equivalence-relation.qmd)です：
...
graph TD
    ...
    click ax-induction "ax-induction.html" "数学的帰納法の公理へ"
...
- マウスホイールで**ズーム**イン/アウト
- ノードに**ホバー**して詳細を表示
- [別ウィンドウ](../../output/interactive/ja/def-congruence.html){target="_blank"}で完全なインタラクティブ版を表示
