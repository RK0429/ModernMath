...
**ステップ1**：$a$ と $b$ の任意の公[約数](def-divisibility.qmd)が、$b$ と $r$ の公約数でもあることを示す。

$d \mid a$ かつ $d \mid b$ ならば、$d \mid (a - qb) = r$ です。したがって $d$ は $b$ と $r$ の両方を[割り切ります](def-divisibility.qmd)。
