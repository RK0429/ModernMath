...
3. **Ring**: In the category of rings, monomorphisms are the injective [ring homomorphisms](../algebra/def-ring-homomorphism.qmd)
...
- View the [full interactive version](../../output/interactive/en/def-monomorphism.html){target="_blank"}
