...
Let $f: A \to B$ be a [function](../logic-set-theory/def-function.qmd) where $A$ and $B$ are finite [Set](../logic-set-theory/def-set.qmd)s with $|A| > |B|$. Then $f$ is not injective; that is, there exist distinct elements $a_1, a_2 \in A$ such that $f(a_1) = f(a_2)$.
