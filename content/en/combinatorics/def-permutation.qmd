...
A **permutation** of a [Set](../logic-set-theory/def-set.qmd) is a bijective function from the set to itself.
...
- View the [full interactive version](../../output/interactive/def-permutation.html){target="_blank"} in a new window
