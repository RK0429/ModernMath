...
### For Directed Graphs
- The sum of all in-degrees equals the sum of all out-degrees: $\sum_{v \in V} \deg^-(v) = \sum_{v \in V} \deg^+(v) = |E|$
...
- View the [full interactive version](../../output/interactive/def-graph.html){target="_blank"}
