...
### Number Theory
- **GCD**: $\gcd(a, b) = \gcd(b, a)$ (see @../number-theory/def-gcd)
- **LCM**: $\text{lcm}(a, b) = \text{lcm}(b, a)$ (see @../number-theory/def-lcm)
...
1. **[Abelian Groups](def-abelian-group.qmd)**: [Groups](def-group.qmd) with commutative operation
...
- View the [full interactive version](../../output/interactive/en/def-commutativity.html){target="_blank"}
