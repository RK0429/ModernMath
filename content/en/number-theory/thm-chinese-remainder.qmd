...
**Uniqueness**: If $x$ and $y$ are both solutions, then $x \equiv y \pmod{m_i}$ for all $i$. Thus $m_i$ divides $x - y$ for all $i$. Since the $m_i$ are pairwise coprime, their product $M$ divides $x - y$, so $x \equiv y \pmod{M}$.
