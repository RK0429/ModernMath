...
status: complete
title: Congruence (Modular Arithmetic)
translations:
...
# Congruence (Modular Arithmetic) {#def-congruence}
...
- View the [full interactive version](../../output/interactive/en/def-congruence.html){target="_blank"}
