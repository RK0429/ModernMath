...
The integers coprime to $n$ form a [Group](../algebra/def-group.qmd) under multiplication modulo $n$, denoted $(\mathbb{Z}/n\mathbb{Z})^*$. This group has order $\phi(n)$, so by Lagrange's theorem, any element raised to the group order equals the identity.
...
- View the [full interactive version](../../output/interactive/thm-euler.html){target="_blank"} in a new window
