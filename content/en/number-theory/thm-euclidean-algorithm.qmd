...
where $a \bmod b$ is the remainder when $a$ is divided by $b$. This remainder is the representative of the equivalence class of $a$ in the quotient $\mathbb{Z}/b\mathbb{Z}$ (see [Example: Integers Modulo n](../algebra/ex-quotient-integers-mod-n.qmd)).
...
**Step 1**: Show that any common [divisor](def-divisibility.qmd) of $a$ and $b$ is also a common divisor of $b$ and $r$.

If $d \mid a$ and $d \mid b$, then $d \mid (a - qb) = r$. Thus $d$ [divides](def-divisibility.qmd) both $b$ and $r$.
