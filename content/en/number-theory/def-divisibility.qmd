...
requires: []
status: complete
title: 'Definition: Divisibility'
type: Definition
---

# Definition: Divisibility {#def-divisibility}
...
The divisibility relation is closely connected to the division algorithm. Given integers $a$ and $b$ with $b > 0$, by the division algorithm:
...
- View the [full interactive version](../../output/interactive/def-divisibility.html){target="_blank"}
