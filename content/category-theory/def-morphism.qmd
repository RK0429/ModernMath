...
A **morphism** (also called an arrow) is a fundamental concept in [Category](category-theory/def-category.qmd) theory representing a structure-preserving map between objects.

## Formal Definition

In a [Category](category-theory/def-category.qmd) $\mathcal{C}$, a morphism $f: A \to B$ consists of:
