...
A **morphism** (also called an arrow) is a fundamental concept in @def-category theory representing a structure-preserving map between objects.

## Formal Definition

In a @def-category $\mathcal{C}$, a morphism $f: A \to B$ consists of:
