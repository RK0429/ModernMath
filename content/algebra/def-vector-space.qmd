...
A **vector space** (or linear space) over a field $F$ is a @def-set $V$ together with two @def-binary-operation[s]:
...
- The vector space axioms ensure that $(V, +)$ forms an abelian @def-group
