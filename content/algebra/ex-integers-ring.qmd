...
The set of integers $\mathbb{Z}$ with usual addition and multiplication forms a @def-ring, denoted $(\mathbb{Z}, +, \cdot)$.

## Ring Axioms Verification

### Additive Group Structure

The integers form an abelian @def-group under addition:
