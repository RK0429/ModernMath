...
The set of integers $\mathbb{Z}$ with usual addition and multiplication forms a [Ring](algebra/def-ring.qmd), denoted $(\mathbb{Z}, +, \cdot)$.

## Ring Axioms Verification

### Additive Group Structure

The integers form an abelian [Group](algebra/def-group.qmd) under addition:
