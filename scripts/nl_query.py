...
class NaturalLanguageQueryProcessor:
    ...
    def __init__(self, sparql_endpoint: str = "http://localhost:3030/mathwiki/sparql"):
        ...
        self.patterns = {
            ...
            "dependents": [
                ...
                r"(?:show|list|find) (?:all )?(?:theorems|concepts) that (?:use|depend on|require) (.+)",
                r"where is (.+?) used",
    ...
    def format_response(self, intent: QueryIntent, results: List[Dict[str, Any]]) -> str:
        ...
        if not results:
            return f"I couldn't find any information about that. Please check if the concept exists in the knowledge graph."
