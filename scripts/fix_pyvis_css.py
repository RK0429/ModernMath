...
def fix_css_path(html_file: Path) -> bool:
    ...
    try:
        ...
        original_pattern = r'https://cdnjs\.cloudflare\.com/ajax/libs/vis-network/[\d.]+/dist/dist/vis-network\.min\.css'
        fixed_pattern = r'https://cdnjs.cloudflare.com/ajax/libs/vis-network/\g<1>/dist/vis-network.min.css'
        
        # Find and replace using regex
        pattern = re.compile(r'https://cdnjs\.cloudflare\.com/ajax/libs/vis-network/([\d.]+)/dist/dist/vis-network\.min\.css')
