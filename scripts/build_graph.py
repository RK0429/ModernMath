...
class KnowledgeGraphBuilder:
    ...
    def _process_file_first_pass(self, qmd_path: Path):
        ...
        try:
            ...
            if content_lines:
                ...
                first_paragraph = re.sub(r'^#+\s+.*$', '', first_paragraph, flags=re.MULTILINE).strip()
                if first_paragraph:
    ...
    def _save_graph(self):
        ...
        self.graph.add((ontology_uri, RDFS.label, Literal("Mathematics Knowledge Graph Ontology", lang='en')))
        self.graph.add((ontology_uri, RDFS.comment, 
                       Literal("An ontology for representing mathematical knowledge as a graph", lang='en')))
