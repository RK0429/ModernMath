...
def create_visualization_index(output_dir: Path, html_files: list) -> None:
...
"""
    ...
    for file in domain_files:
        ...
        index_content += f'            <a href="{file.name}" class="viz-link domain-link">{domain_name}</a>\n'
...
"""
    ...
    <div class="section">
        <p style="text-align: center; color: #666; margin: 0;">
            ...
            Total visualizations: """ + str(len(html_files)) + """
        </p>
    </div>
</body>
</html>"""
