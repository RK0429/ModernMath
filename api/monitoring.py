    ...
    def decorated_function(*args, **kwargs):
        ...
        try:
            ...
            metrics_collector.record_request(
                request.endpoint, request.method, status_code, duration_ms
            )
            ...
            # Record error
            metrics_collector.record_request(request.endpoint, request.method, 500, duration_ms)
        ...
        def decorated_function(*args, **kwargs):
            ...
            try:
                ...
                if duration_ms > 1000:  # Log queries over 1 second
                    structured_logger.log_metric("slow_query", duration_ms, query_type=query_type)
...
class HealthChecker:
    ...
    def check_fuseki_health(endpoint: str) -> Dict[str, Any]:
        ...
        try:
            ...
            sparql.query().convert()  # Test the query
            duration_ms = (time.time() - start_time) * 1000

            return {"status": "healthy", "response_time_ms": round(duration_ms, 2)}
    ...
    def after_request(response):
        if hasattr(g, "start_time"):
            ...
            if request.endpoint != "health_check":
                metrics_collector.record_request(
                    request.endpoint or "unknown", request.method, response.status_code, duration_ms
                )
